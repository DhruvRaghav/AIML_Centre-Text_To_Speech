...
<body>
<form>
  <input id="text" type="text" size="80" placeholder="Enter Text">
...
if __name__ == '__main__':
  ...
  parser.add_argument('--checkpoint', default='weights/model.ckpt-1324000',
                      help='Full path to model checkpoint')
  parser.add_argument('--port', type=int, default=9000)
  parser.add_argument('--hparams', default="max_iters=400,use_cmudict=True",
